...
import 'provider_dashboard_copy_model.dart';
export 'provider_dashboard_copy_model.dart';

class ProviderDashboardCopyWidget extends StatefulWidget {
  const ProviderDashboardCopyWidget({Key? key}) : super(key: key);

  @override
  _ProviderDashboardCopyWidgetState createState() =>
      _ProviderDashboardCopyWidgetState();
}

class _ProviderDashboardCopyWidgetState
    extends State<ProviderDashboardCopyWidget> {
  late ProviderDashboardCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProviderDashboardCopyModel());
  ...
  Widget build(BuildContext context) {
    ...
    return AuthUserStreamWidget(
      builder: (context) => StreamBuilder<ProviderDocumentsRecord>(
        stream: ProviderDocumentsRecord.getDocument(
        ...
        builder: (context, snapshot) {
          ...
          final providerDashboardCopyProviderDocumentsRecord = snapshot.data!;
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    providerDashboardCopyProviderDocumentsRecord
                                        .rating
                                        .toString(),
                                    style: FlutterFlowTheme.of(context)
                                        .displaySmall
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        8.0, 8.0, 8.0, 8.0),
                                    child: Text(
                                      'Average rating by ${providerDashboardCopyProviderDocumentsRecord.totalClients.toString()} users',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Poppins',
                        ...
                        child: Container(
                          ...
                          child: StreamBuilder<List<ClientsRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<ClientsRecord> columnClientsRecordList =
                                  snapshot.data!;
                              return Column(
                                mainAxisSize: MainAxisSize.max,
                                crossAxisAlignment: CrossAxisAlignment.start,
                                              ...
                                              Expanded(
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      'K${columnSkillsRecord.charge.toString()}',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .bodyMedium,
                          ...
                          child: StreamBuilder<List<ClientReviewRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<ClientReviewRecord>
                                  columnClientReviewRecordList = snapshot.data!;
                              return Column(
                                mainAxisSize: MainAxisSize.max,
                                children: List.generate(
                                    columnClientReviewRecordList.length,
                                    (columnIndex) {
                                  final columnClientReviewRecord =
                                      columnClientReviewRecordList[columnIndex];
                                  return Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 0.0, 0.0, 8.0),
                                    child: Material(
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        wrapWithModel(
                                                          ...
                                                          child: Rating2Widget(
                                                            key: Key(
                                                              'Keyl9f_${columnClientReviewRecord.rating.toString()}',
                                                            ),
                                                          ),
                                                        ),
                                                        Text(
