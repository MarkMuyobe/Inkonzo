...
class _SearchPageWidgetState extends State<SearchPageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      logFirebaseEvent('searchPage_update_widget_state');
      setState(() {
        _model.here = currentUserLocationValue;
      });
    });
                            ...
                            child: Row(
                              ...
                              children: [
                                  ...
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      onFieldSubmitted: (_) async {
                                        logFirebaseEvent(
                                            'SEARCH_Query_ON_TEXTFIELD_SUBMIT');
                                        currentUserLocationValue =
                                ...
                                FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'SEARCH_PAGE_PAGE_send_ICN_ON_TAP');
                                    logFirebaseEvent(
                                ...
                                child: Material(
                                  ...
                                  child: Container(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'SEARCH_PAGE_PAGE_Icon_e9vtjf61_ON_TAP');
                                ...
                                child: Padding(
                                  ...
                                  child: FlutterFlowChoiceChips(
                                    ...
                                    onChanged: (val) async {
                                      ...
                                      logFirebaseEvent(
                                          'SEARCH_ChoiceChipsSet_ON_FORM_WIDGET_SEL');
                                      logFirebaseEvent(
                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Builder(
                                builder: (context) {
                                  if (containerProviderDocumentsRecordList ==
                                      null) {
                                    return Center(
                                      child: SizedBox(
                                        width: 50.0,
                                      ...
                                      children: List.generate(allItems.length,
                                        ...
                                        return Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'SEARCH_PAGE_PAGE_Store_ListView_ON_TAP');
                                              logFirebaseEvent(
                                                                    ...
                                                                    children: [
                                                                      wrapWithModel(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          key:
                                                                              Key(
                                                                            'Keyxvz_${allItemsItem.rating.toString()}',
                                                                          ),
                                                                        ),
                                                                      ),
                                                                      Text(
                                      ...
                                      Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            ...
                                            context.pushNamed('ProviderDetail');
                                          },
                                          child: Material(
                                            color: Colors.transparent,
                                            elevation: 3.0,
