              ...
              children: [
                            ...
                            child: Padding(
                              ...
                              child: AuthUserStreamWidget(
                                builder: (context) => InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'USER_SETTINGS_PAGE_Image_agrst61w_ON_TAP');
                      ...
                      if (Theme.of(context).brightness == Brightness.light)
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'USER_SETTINGS_PAGE_isLightMode_ON_TAP');
                              logFirebaseEvent(
                      ...
                      if (Theme.of(context).brightness == Brightness.dark)
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'USER_SETTINGS_PAGE_isDarkMode_ON_TAP');
                              logFirebaseEvent(
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      logFirebaseEvent(
                          'USER_SETTINGS_PAGE_contentView_1_ON_TAP');
                      logFirebaseEvent('contentView_1_show_snack_bar');
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text(
                            'Feature soon to be updated.',
                            style: TextStyle(
                              color: FlutterFlowTheme.of(context).primaryText,
                            ),
                          ),
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      logFirebaseEvent(
                          'USER_SETTINGS_PAGE_SettingsCard_ON_TAP');
                      logFirebaseEvent('SettingsCard_navigate_to');
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      ...
                      context.pushNamed('ProviderRegister');
                    },
                    child: Container(
                      width: double.infinity,
                      height: 60.0,
