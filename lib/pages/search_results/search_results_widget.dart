              ...
              children: [
                        ...
                        valueOrDefault<String>(
                          () {
                            if (_model.choiceChipsSetValue == 'closest') {
                              return _model.algoliaSearchResults?.length;
                            } else if (_model.choiceChipsSetValue ==
                                'available') {
                      ...
                      builder: (context, snapshot) {
                        ...
                        return Column(
                          ...
                          children: List.generate(
                            ...
                            return Visibility(
                              visible: !activeSearchListProviderDocumentsRecord
                                  .availability,
                              child: Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    8.0, 8.0, 8.0, 8.0),
                                                          ...
                                                          children: [
                                                            wrapWithModel(
                                                              ...
                                                              child:
                                                                ...
                                                                key: Key(
                                                                  'Keyk2t_${activeSearchListProviderDocumentsRecord.rating.toString()}',
                                                                ),
                                                              ),
                                                            ),
                                                            Text(
                        ...
                        return Column(
                          ...
                          children: List.generate(availablelist.length,
                            ...
                            final availablelistItem =
                                availablelist[availablelistIndex];
                            return Visibility(
                              visible: availablelistItem.availability,
                              child: Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    8.0, 8.0, 8.0, 8.0),
                                child: InkWell(
                ...
                if (_model.choiceChipsSetValue == 'new')
                  Flexible(
                    child: Builder(
                      builder: (context) {
                        final sortedByDate = functions
                            .sortByDateJoined(
                                _model.algoliaSearchResults?.toList())
                            .toList();
                        return Column(
                          mainAxisSize: MainAxisSize.max,
                          children: List.generate(sortedByDate.length,
                              (sortedByDateIndex) {
                            final sortedByDateItem =
                                sortedByDate[sortedByDateIndex];
                            return Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  8.0, 8.0, 8.0, 8.0),
                              child: InkWell(
                                                        ...
                                                        children: [
                                                          wrapWithModel(
                                                            ...
                                                            child:
                                                                ProviderRatingWidget(
                                                              key: Key(
                                                                'Keyx03_${sortedByDateItem.rating.toString()}',
                                                              ),
                                                            ),
                                                          ),
                                                          Text(
                ...
                if (_model.choiceChipsSetValue == 'closest')
                  Flexible(
                    child: Builder(
                      builder: (context) {
                        final sortByDistance = functions
                            .getProviderDocumentsSorted(
                                _model.algoliaSearchResults!.toList(),
                                currentUserLocationValue!)
                            .toList();
                        return Column(
                          mainAxisSize: MainAxisSize.max,
                          children: List.generate(sortByDistance.length,
                              (sortByDistanceIndex) {
                            final sortByDistanceItem =
                                sortByDistance[sortByDistanceIndex];
                            return Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  8.0, 8.0, 8.0, 8.0),
                              child: InkWell(
                                                        ...
                                                        children: [
                                                          wrapWithModel(
                                                            ...
                                                            child:
                                                                ProviderRatingWidget(
                                                              key: Key(
                                                                'Keyxlq_${sortByDistanceItem.rating.toString()}',
                                                              ),
                                                            ),
                                                          ),
                                                          Text(
