  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<BookingsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final trackingDetailBookingsRecord = snapshot.data!;
          ...
          child: Scaffold(
            ...
            body: StreamBuilder<ProviderDocumentsRecord>(
              stream: ProviderDocumentsRecord.getDocument(
                  trackingDetailBookingsRecord.providerRef!),
              builder: (context, snapshot) {
                // Customize what your widget looks like when it's loading.
                if (!snapshot.hasData) {
                  return Center(
                ...
                return Column(
                  ...
                  children: [
                      ...
                      children: [
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              8.0, 8.0, 8.0, 8.0),
                          child: Text(
                            trackingDetailBookingsRecord.providerName,
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Image.network(
                              trackingDetailBookingsRecord.providerImage,
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
                    ...
                    if (trackingDetailBookingsRecord.bookingStatus == 'Active')
                      Padding(
                        padding:
                    ...
                    Builder(
                      builder: (context) {
                        final comments = columnProviderDocumentsRecord
                            .inkonzoComments
                            .toList();
                        return Wrap(
                          spacing: 10.0,
                    ...
                    Row(
                      ...
                      children: [
                        if (trackingDetailBookingsRecord.bookingStatus ==
                            'Active')
                          FFButtonWidget(
                            onPressed: () async {
