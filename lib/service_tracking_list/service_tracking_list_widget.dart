...
class ServiceTrackingListWidget extends StatefulWidget {
  const ServiceTrackingListWidget({Key? key}) : super(key: key);
              ...
              child: Column(
                ...
                children: [
                  ...
                  Builder(
                    builder: (context) {
                      final bookings =
                          serviceTrackingListBookingsRecordList.toList();
                                                ...
                                                Padding(
                                                  padding: EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          0.0, 0.0, 8.0, 0.0),
                                                  child: Text(
                                                    'K${bookingsItem.bookingPrice.toString()}',
